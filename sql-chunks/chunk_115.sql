...
VALUES (
    '12345678-1234-5678-abcd-dex0013', 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0014', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.emotion_grid_usage WHERE session_id = '12345678-1234-5678-abcd-dex0014'), 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    'calm', 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0015', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0016', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.emotion_grid_usage WHERE session_id = '12345678-1234-5678-abcd-dex0016'), 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    'excited', 
    'high-energy-comfortable', 
    '😊', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.wellbeing_wheel_usage WHERE session_id = '12345678-1234-5678-abcd-dex0016'), 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    'my_friends', 
    'happy', 
    4, 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0017', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0018', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.emotion_grid_usage WHERE session_id = '12345678-1234-5678-abcd-dex0018'), 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    'frustrated', 
    'high-energy-comfortable', 
    '😊', 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0019', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
INSERT INTO public.checkin_sessions (id, child_id, org_id, started_at, completed_at, status, tools_completed, created_at, updated_at) 
VALUES (
    '12345678-1234-5678-abcd-dex0020', 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    '5f910546-8bdc-44ca-b776-fdd5eb5cccd9', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.emotion_grid_usage WHERE session_id = '12345678-1234-5678-abcd-dex0020'), 
    'aaaabbbb-cccc-dddd-eeee-222222222229', 
    'calm', 
    'high-energy-comfortable', 
    '😊', 
