-- Combined SQL Batch 7
-- Contains chunks 61 to 70
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
...
INSERT INTO public.mood_meter_usage (id, session_id, child_id, org_id, mood_level, mood_numeric, selected_at, time_to_select_seconds, was_skipped, notes, created_at) 
VALUES (
    gen_random_uuid(), (SELECT id FROM public.checkin_sessions WHERE child_id = (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child') ORDER BY created_at DESC LIMIT 1), 
    (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    'happy', 
    4, 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.emotion_grid_usage WHERE child_id = (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child') ORDER BY created_at DESC LIMIT 1), 
    (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child'), 
    'empathetic', 
    'high-energy-comfortable', 
    '😊', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.wellbeing_wheel_usage WHERE child_id = (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child') ORDER BY created_at DESC LIMIT 1), 
    (SELECT id FROM public.profiles WHERE name = 'Zara Ahmed' AND role = 'Child'), 
    'my_friends', 
    'ok', 
    3, 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
...
INSERT INTO public.mood_meter_usage (id, session_id, child_id, org_id, mood_level, mood_numeric, selected_at, time_to_select_seconds, was_skipped, notes, created_at) 
VALUES (
    gen_random_uuid(), (SELECT id FROM public.checkin_sessions WHERE child_id = (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child') ORDER BY created_at DESC LIMIT 1), 
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    'happy', 
    4, 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.emotion_grid_usage WHERE child_id = (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child') ORDER BY created_at DESC LIMIT 1), 
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    'conflicted', 
    'high-energy-comfortable', 
    '😊', 
...
VALUES (
    gen_random_uuid(), 
    (SELECT id FROM public.wellbeing_wheel_usage WHERE child_id = (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child') ORDER BY created_at DESC LIMIT 1), 
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    'my_friends', 
    'very_happy', 
    5, 
...
VALUES (
    ...
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    '2025-03-03T17:33:00+00', 
    '2025-03-03T17:38:00+00', 
    300, 
    'basic_inhale_exhale', 
    16, 
    false,
...
VALUES (
    ...
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    '2025-03-05T16:47:00+00', 
    '2025-03-05T16:51:00+00', 
    3, 
    'learning to handle bilingual confidence better each day', 
    55, 
    'typing', 
...
VALUES (
    ...
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    '2025-03-07T16:15:00+00', 
    '2025-03-07T16:38:00+00', 
    'completed', 
    ARRAY['mood_meter'], 
    now(), 
    now()
...
VALUES (
    ...
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    '2025-03-12T15:45:00+00', 
    '2025-03-12T15:55:00+00', 
    'completed', 
    ARRAY['mood_meter'], 
    now(), 
    now()
...
VALUES (
    ...
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    '2025-03-14T17:45:00+00', 
    '2025-03-14T17:59:00+00', 
    'completed', 
    ARRAY['mood_meter', 'emotion_grid'], 
    now(), 
    now()
...
VALUES (
    ...
    (SELECT id FROM public.profiles WHERE name = 'Ethan Davis' AND role = 'Child'), 
    (SELECT id FROM public.organisations WHERE name = 'Westfield Primary School'), 
    '2025-03-14T17:47:00+00', 
    '2025-03-14T17:51:00+00', 
    3, 
    'learning to handle bilingual confidence better each day', 
    55, 
    'typing', 
